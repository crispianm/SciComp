...
for value in Δt_max
    ...
    three_eighths_rule_sol =
        solve_ode(f, x0, t; method = "three_eighths_rule", Δt = value)[end][1]
...
t1 = scatter(x = Δt_max, y = euler_error, mode = "lines", name = "Euler")
...
t5 = scatter(x = Δt_max, y = rk4_error, mode = "lines", name = "RK4")
